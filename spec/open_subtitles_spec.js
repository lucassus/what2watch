...
describe('OpenSubtitles', function() {
  ...
  describe('.login', function() {
    ...
    describe('on success', function() {
      ...
      beforeEach(function() {
        nock('http://api.opensubtitles.org').post('/xml-rpc')
          .replyWithFile(200, __dirname + '/replies/login/success.xml');
      });
    ...
    describe('on error', function() {
      ...
      beforeEach(function() {
        nock('http://api.opensubtitles.org').post('/xml-rpc')
          .replyWithFile(200, __dirname + '/replies/login/error.xml');
      });
  ...
  describe('.checkMovieHash', function() {
    ...
    describe('on success', function() {
      ...
      beforeEach(function() {
        nock('http://api.opensubtitles.org').post('/xml-rpc')
          .replyWithFile(200, __dirname + '/replies/check_movie_hash/success.xml');
      });
    ...
    describe('when the hash is missing', function() {
      ...
      beforeEach(function() {
        nock('http://api.opensubtitles.org').post('/xml-rpc')
          .replyWithFile(200, __dirname + '/replies/check_movie_hash/missing_hash.xml');
      });
  ...
  describe('.getIMDBMovieDetails', function() {
    ...
    describe('on success', function() {
      ...
      beforeEach(function() {
        nock('http://api.opensubtitles.org').post('/xml-rpc')
          .replyWithFile(200, __dirname + '/replies/get_imdb_movie_details/success.xml');
      });
    ...
    describe('on error', function() {
      ...
      beforeEach(function() {
          nock('http://api.opensubtitles.org').post('/xml-rpc')
            .replyWithFile(200, __dirname + '/replies/get_imdb_movie_details/error.xml');
        });
